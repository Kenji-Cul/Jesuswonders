...
<body>
    ...
    <div class="wrap-container">
        ...
        <main>
           <section class="allvideos">
               ...
               <?php 
                $select = new User;
                $selectvideo = $select->selectAllPosts();
               ...
               <div class="deletemodal">
                   <h2>Are you sure you want to delete all the posts?</h2>
                   ...
                   <div class="post vid">
                      ...
                      <div class="buttons-container">
                         <button class="deletebtn">
                            <a href="deletepost.php?postid=<?php echo $value['unique_id'];?>">Delete Post</a>
                         </button>
                      </div>
                      </div>
               <?php  }} else {?>
    ...
    function DeleteAllContent(){
                ...
                xhr.open("POST", "deleteallposts.php", true);
                xhr.onload = () => {
