...
<body>
    ...
    <div class="wrap-container">
        ...
        <main>
           <section class="allvideos">
               ...
               <?php 
                $select = new User;
                $selectvideo = $select->selectAllVerses(); 
               ...
               <div class="deletemodal">
                   <h2>Are you sure you want to delete all the verses?</h2>
               ...
               <div class="videos-container">
                ...
                if(!empty($selectvideo)){
                   ...
                   <div class="post vid">
                       <div class="versecon">
                       <h2><?php echo $value['chapter'];?></h2>
                       <p><?php echo $value['versecontent'];?></p>
                       </div>
                      <div class="buttons-container">
                         <button class="deletebtn">
                            <a href="deleteverse.php?verseid=<?php echo $value['unique_id'];?>">Delete Verse</a>
                         </button>
                      </div>
                      </div>
               <?php  }} else {?>
                <h2>No Verses Added Yet</h2>
                <?php }?>
                </div>
           </section>
        </main>
    ...
    function DeleteAllContent(){
                ...
                xhr.open("POST", "deleteallverses.php", true);
                xhr.onload = () => {
